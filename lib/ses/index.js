...
var sesClient = ses.createClient({ key: config.aws.ses.key, secret: config.aws.ses.select , amazon: config.aws.ses.region});

var emailData = {};
var imgBasePath = config.emailImg.basePath;
var imgMainLogo = config.emailImg.mainLogo;
var imgFailStatusLogo = config.emailImg.failStatusLogo;
var imgFailLogo = config.emailImg.failLogo;
var imgSuccessStatusLogo = config.emailImg.successStatusLogo;
var imgSuccessLogo = config.emailImg.successLogo;
